...
export class LoanApplicationRepository implements DefaultCrudRepository<LoanApplication> {
    ...
    async create(loanApplication: LoanApplication) {
        ...
        (await this.dataSource).set(loanApplicationId, JSON.stringify(loanApplication));
     ...
     */
    async update(loanApplicationId: string, loanApplication: Partial<LoanApplication>) {
        await (await this.dataSource).set(loanApplicationId, JSON.stringify(loanApplication));
    }
